<?php
   ...
   */
  $serverUrls = array(
    array( 'url' => 'http://tasks.arcgisonline.com/ArcGIS/rest/services', 'matchAll' => true, 'token' => ''),
    array( 'url' => 'http://www.idealista.com/', 'matchAll' => true, 'tokenParam' => 'k', 'token' => 'xxxxxxxxxxxxxxx'  ),
  ...
  if ($token) {
    $tokenParam = isset($serverUrls[$pos]['tokenParam'])? $serverUrls[$pos]['tokenParam'] : 'token';
    $targetUrl .= (stripos($targetUrl, "?") !== false ? '&' : '?').$tokenParam.'='.$token;
  }
